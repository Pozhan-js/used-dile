  ...
  <body>
    <div>
      ...
      <div style="margin-top: 5px;">
        <div style="text-indent: 2em; font-weight: 900;">1. 适用范围</div>
        <div style="text-indent: 2em;">
      ...
      <div style="margin-top: 5px;">
        <div style="text-indent: 2em; font-weight: 900;">2. 信息使用</div>
        <div style="text-indent: 2em;">
      ...
      <div style="margin-top: 5px;">
        <div style="text-indent: 2em; font-weight: 900;">3. 信息披露</div>
        <div style="text-indent: 2em;">
      ...
      <div style="margin-top: 5px;">
        <div style="text-indent: 2em; font-weight: 900;">4. 信息存储和交换</div>
        <div style="text-indent: 2em;">
          本应用收集的有关您的信息和资料将保存在本应用及（或）其关联公司的服务器上，这些信息和资料可能传送至您所在国家、地区或本应用收集信息和资料所在地的境外并在境外被访问、存储和展示。
        </div>
      </div>
      <div style="margin-top: 5px;">
        <div style="text-indent: 2em; font-weight: 900;">5. Cookie的使用</div>
        <div style="text-indent: 2em;">
      ...
      <div style="margin-top: 5px;">
        <div style="text-indent: 2em;">6.本隐私政策的更改</div>
        <div style="text-indent: 2em;">
